...
class sPRO(Metric):
    ...
    def compute(self) -> Tensor:
        """Compute the macro average of the sPRO score across all regions in all batches."""
...
def pro_score(predictions: Tensor, comps: Tensor, threshold: float = 0.5) -> Tensor:
    ...
    Returns:
        Tensor: Scalar value representing the average sPRO score for the input batch.
    """
